...
import { PageCreateOrphanage, Main, OrphanageForm, InputBlock } from './stylesCreateOrphanage';
...
export default function CreateOrphanage() {
    ...
    return (
        <PageCreateOrphanage>
            <Sidebar />
            <Main>
                <OrphanageForm onSubmit={handleSubmit}>
                    <fieldset>
                        <legend>Dados</legend>

                        <div className="map-createOrphanage">

                            <Map
                                center={[-29.6539967, -50.7804193]}
